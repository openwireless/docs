...
## 電源について
  ...
  * PCとUSBケーブルで接続した状態でも、別途電源の供給が必要です（USB空の給電はできません）
    * リチウムポリマ電池(電池容量400mAh以上)の利用を推奨します。リチウムポリマ電池にオスのPHコネクタを取り付け、コネクタCN1に差し込みます。

<img src="docs/mgim_battery.jpg" width="300">
